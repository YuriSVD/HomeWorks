...
for (let user of usersList) {
    ...
    for (let item in user) {
        ...
        if (typeof info === "object") {
            for (let anotherItem in info) {
                let anotherDiv = document.createElement("div");
                let itemOfAnotherInfo = info[anotherItem];
                if (typeof itemOfAnotherInfo === "object") {
                    for (let someAnotherItem in itemOfAnotherInfo) {
                        let someAnotherDiv = document.createElement("div");
                        let anotherItemOfAnotherInfo = itemOfAnotherInfo[someAnotherItem];
                        someAnotherDiv.innerText = `${someAnotherItem} : ${anotherItemOfAnotherInfo}`;
                        userDiv.append(someAnotherDiv);
                    }
                } else {
                    anotherDiv.innerText = `${anotherItem} : ${itemOfAnotherInfo}`;
                    userDiv.append(anotherDiv);
                }
            }
        } else {
            itemDiv.innerText = `${item} : ${info}`;
